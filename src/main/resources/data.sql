...
values(1, 'Letterpress', 'I''m baby letterpress celiac chicharrones chillwave chartreuse kale chips godard prism. Put a
...
insert into Definition(id, word, definition, example, submitted_by, submitted_on, likes, dislikes, approved)
values(2, 'Venmo', 'Venmo roof party enamel pin shaman wolf la croix truffaut flexitarian hoodie squid palo santo
...
insert into Definition(id, word, definition, example, submitted_by, submitted_on, likes, dislikes, approved)
values(3, 'Bitters', 'Bitters synth venmo swag kitsch ethical, green juice tumeric godard gentrify raclette live-edge
...
insert into Definition(id, word, definition, example, submitted_by, submitted_on, likes, dislikes, approved)
values(4, 'PBR&B', 'Thundercats master cleanse twee messenger bag retro PBR&B 8-bit iPhone pickled crucifix occupy tote
...
insert into Definition(id, word, definition, example, submitted_by, submitted_on, likes, dislikes, approved)
values(5, 'Keytar', 'Keytar unicorn affogato, 8-bit YOLO heirloom pok pok poutine ethical la croix. Pork belly sriracha
