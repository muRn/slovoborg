...
insert into Definition(id, word, definition, example, submitted_by, submitted_on, likes, dislikes, approved)
values(hibernate_sequence.nextval, 'Letterpress', 'I''m baby letterpress celiac chicharrones chillwave chartreuse kale chips godard prism. Put a
...
insert into Definition(id, word, definition, example, submitted_by, submitted_on, likes, dislikes, approved)
values(hibernate_sequence.nextval, 'Venmo', 'Venmo roof party enamel pin shaman wolf la croix truffaut flexitarian hoodie squid palo santo
...
insert into Definition(id, word, definition, example, submitted_by, submitted_on, likes, dislikes, approved)
values(hibernate_sequence.nextval, 'Bitters', 'Bitters synth venmo swag kitsch ethical, green juice tumeric godard gentrify raclette live-edge
...
insert into Definition(id, word, definition, example, submitted_by, submitted_on, likes, dislikes, approved)
values(hibernate_sequence.nextval, 'PBR&B', 'Thundercats master cleanse twee messenger bag retro PBR&B 8-bit iPhone pickled crucifix occupy tote
...
insert into Definition(id, word, definition, example, submitted_by, submitted_on, likes, dislikes, approved)
values(hibernate_sequence.nextval, 'Keytar', 'Keytar unicorn affogato, 8-bit YOLO heirloom pok pok poutine ethical la croix. Pork belly sriracha
...
values(hibernate_sequence.nextval, 1, '127.0.0.1', 1, parsedatetime('30-09-2020 12:34:56', 'dd-MM-yyyy HH:mm:ss'));

insert into Opinion(id, definition_id, ip_address, opinion, updated_at)
values(hibernate_sequence.nextval, 2, '127.0.0.1', -1, parsedatetime('01-10-2020 12:34:56', 'dd-MM-yyyy HH:mm:ss'));